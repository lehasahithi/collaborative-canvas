...
🖥️ Responsive layout for desktops and tablets
✏️ Smooth brush rendering using quadratic curves for natural strokes
...
(Attach your screenshot here for GitHub display)
